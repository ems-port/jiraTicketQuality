...
create table if not exists public.misclassified_feedback (
    ...
    constraint misclassified_feedback_issue_user_unique unique (issue_key, user_id)
);

create index if not exists idx_misclassified_feedback_issue on public.misclassified_feedback (issue_key);
create index if not exists idx_misclassified_feedback_user on public.misclassified_feedback (user_id);
